...
export function staticPolicyFromEnv(env: NodeJS.ProcessEnv = process.env, trust: TrustPolicy = trustPolicyFromEnv(env), exists?: (path: string) => boolean): StaticPolicy {
